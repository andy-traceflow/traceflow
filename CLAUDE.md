...
| `docs/decisions/` | Architecture Decision Records (ADRs). 0001 multi-tenant RLS · 0002 caller-classification runtime · 0003 recovered-revenue attribution · 0004 self-hosted admin (replaces Retool) · 0005 contact identity + config-driven qualification |
